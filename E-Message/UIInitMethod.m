...
UICollectionView *InsertCollectionView(id superView,UIColor *backgroundColor , CGRect rect, id<UICollectionViewDataSource>dataSource,id <UICollectionViewDelegate>delegate,NSString * kcellID, Class collectionViewCellClass,CGFloat itemW,CGFloat itemH ,CGFloat MiniInteritemSpacing, CGFloat MiniLineSpacing) {
    ...
    [collectionView registerClass:collectionViewCellClass forCellWithReuseIdentifier:kcellID];
    if (superView) {
